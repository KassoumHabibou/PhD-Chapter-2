...
## Final dataset
df_global_corrected <- readxl::read_excel("output/data/df_global.xlsx", 
...
panelView::panelview(1  ~ weight_kg, 
          data = df_global, index = c("member_id","survey_year"), 
          xlab = "Year", ylab = "", pre.post = TRUE, by.unit=TRUE)
```
